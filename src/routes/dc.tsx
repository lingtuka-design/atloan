    ...
    setTimeout(() => {
      ...
      if (type === 'cert' && w.isGlobalNDC) {
        ...
        style.innerHTML = `@media print { 
          ...
          .legal-sheet { padding: 15mm 15mm 20mm 15mm !important; margin: 0 !important; page-break-after: always; box-shadow: none !important; border: none !important; min-height: auto !important; box-sizing: border-box !important; }
        }`
      }
